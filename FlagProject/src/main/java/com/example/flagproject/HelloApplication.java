...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button btn3 = new Button("LESOTHO");
        ...
        btn3.setOnAction(e -> displayFlagLesotho());
    ...
    private void displayFlagLesotho() {
        Pane flagPane = createFlagPaneLesotho();
    ...
    private Pane createFlagPaneLesotho() {
        Pane pane = new Pane();
